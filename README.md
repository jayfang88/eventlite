...
The landing page features the Event Index with tabs to selectively display events by their respective category/ticket type. Users can also filter events by location.
